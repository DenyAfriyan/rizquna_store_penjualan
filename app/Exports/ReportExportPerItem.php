...
class ReportExportPerItem implements  WithDrawings, FromView, ShouldAutoSize, WithStyles
{
    protected $jenis_limbah_id;
    ...
    public function __construct($start_date_limbah_masuk,$end_date_limbah_masuk,$start_date_limbah_keluar, $end_date_limbah_keluar,$jenis_limbah_id)
    {
        ...
        $this->jenis_limbah_id = $jenis_limbah_id;
    }
    ...
    public function view(): View
    {
        ...
        ->where('sisa.jenis_limbah_id',$this->jenis_limbah_id)
